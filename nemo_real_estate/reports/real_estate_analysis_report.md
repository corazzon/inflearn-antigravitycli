...
수집된 매물의 보증금과 월세에 대해 기술통계(평균, 중앙값 등) 분석을 실시한 결과는 다음과 같습니다. (단위: 만원)
...
> **주요 통계 해석**:
> - **보증금 규모**: 강남역의 평균 보증금이 약 **6.7억 원**으로 광화문역(약 5.7억 원) 대비 **약 17.1%** 높게 나타났습니다.
> - **월세 규모**: 강남역의 평균 월세가 약 **511만 원**으로 광화문역(약 401만 원) 대비 **약 27.5%** 더 비쌉니다.
...
- **보증금**: 1억~3억 원 구간에 가장 많은 매물이 몰려 있으나, 수억 원 대 이상의 대형 오피스 및 통건물 빌딩 임대 매물이 롱테일 꼬리를 길게 늘어뜨리며 평균값을 끌어올리고 있습니다.
- **월세**: 200만~500만 원대의 중소형 상가/사무실이 다수 분포하고 있으나, 대형 매물은 수천만 원에 육박하여 상당한 양극화를 보입니다.

### ③ 보증금 대비 월세 상관관계 (상권별 분포 비교)
![보증금 vs 월세 산점도](../images/07_price_vs_sale_price.png)
- 전반적으로 보증금(X축)이 증가함에 따라 월세(Y축)도 선형적으로 비례하여 증가하는 양상을 띱니다.
- **강남역 매물**이 **광화문역 매물**보다 더 상단과 우측에 조밀하게 모여 있어, 동일한 보증금 조건 하에서도 강남 상권의 임대료(월세)가 한 단계 더 높게 책정되어 있음을 알 수 있습니다.
...
매물의 비정형 텍스트(상세 설명)에서 중요한 단어의 가중치를 분석한 결과는 다음과 같습니다.
